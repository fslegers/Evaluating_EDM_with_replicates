...
def plot_RMSE_vs_horizon_zoom(df, rho):
    ...
    for len in [25]:
        ...
        path = f"C:/Users/5605407/Documents/PhD/Chapter_1/Resultaten/single time series 2/rho = {rho}/RMSE, horizon/len={len}, zoom.png"
        plt.savefig(path)
...
if __name__ == '__main__':
    ...
    df_28 = df_28[df_28['noise'] < 0.2]
    plot_RMSE_vs_horizon(df_28, 28)
    plot_RMSE_vs_horizon_zoom(df_28, 28)
